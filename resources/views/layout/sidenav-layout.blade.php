...
<div id="sideNavRef" class="side-nav-open">
    ...
    <a href="{{url('/salePage')}}" class="side-bar-item {{ request()-> routeIs('invoicePage')? 'side-bar-item-active' : '' }}">
        <i class="bi bi-currency-dollar"></i>
        <span class="side-bar-item-caption">Create Sale</span>
    </a>

    <a href="{{url('/invoicePage')}}" class="side-bar-item {{ request()-> routeIs('salePage')? 'side-bar-item-active' : '' }}">
